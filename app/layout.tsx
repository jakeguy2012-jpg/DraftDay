...
const nav=[["/","Live Draft"],["/vegas-board","Vegas Board"],["/rankings","Rankings"],["/planner","Draft Planner"],["/simulator","Simulator"],["/settings","Settings"],["/admin/mapping","Player Mapping"]];
